...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderProfileMenu() {
        ...
        profileMenuDropdown.innerHTML = `
            <div class="profile-menu-header">
                <img src="https://placehold.co/44x44/7B447C/FFFFFF?text=A" class="profile-menu-avatar" alt="Аватар">
                <div>
            ...
            <div class="profile-menu-footer">Reflex AI &copy; 2024</div>
        `;
        profileMenuDropdown.querySelectorAll('.profile-menu-list li').forEach(li => {
            li.onclick = () => {
                ...
                if (act === 'logout') {
                    ...
                    alert('Reflex AI — персональный помощник. Версия 20250509.204911');
                } else if (act === 'feedback') {
                    window.open('mailto:support@reflexai.ru', '_blank');
                } else if (act === 'suggest') {
                    window.open('https://t.me/reflexai_support', '_blank');
                } else if (act === 'orders') {
                    alert('История заказов пока недоступна.');
                } else if (act === 'account') {
                    alert('Настройки аккаунта пока недоступны.');
                } else if (act === 'backup') {
                    alert('Резервное копирование доступно только для PRO.');
                }
                closeProfileMenu();
            };
        });
    ...
    // --- При отправке первого сообщения — оно становится названием чата ---
    ...
    function addMessageToChat(text, sender, opts = {}) {
        ...
        if (sender === 'user') {
            ...
            `;
            actionsDiv.querySelector('.btn-copy').onclick = () => {
